...
local Bishop = Class("Bishop", Enemy)
...
function Bishop:initialize(position, occupationMap, isWhite)
	Enemy.initialize(self)

	self.position = position
	self.rotation = 0
	self.sprite = StandingSprite(Chess.image, isWhite and Chess.quads.bishop_white or Chess.quads.bishop_black, position, 0)
...
function Bishop:updateAttackIndicators()
